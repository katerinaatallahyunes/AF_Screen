...
class Predicted_model:
    ...
    def get_model_independent_metrics(self):
        ...
        try:
            ...
            print("Error loading the pickle file, skipping the calculation of iPAE.")
...
#python3 ~/Users/atallahyuneska/Downloads/calculate_template_independent_metrics.py -run_ids Results -path_to_run "/Users/atallahyuneska/Library/CloudStorage/OneDrive-NationalInstitutesofHealth/OReilly_group/Users/Katerina/Projects/MYC Domain-Motif Interactions/Results/ATD3A_MYC" -project_name "MYC_interface_predictions"
